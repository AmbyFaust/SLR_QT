...
class RelatingObjectDto(BaseDto):
    ...
    # Функция для удаления объекта RelatingObjectDto по id
    @classmethod
    ...
    # Функция для изменения объекта RelatingObjectDto по id
    @classmethod
